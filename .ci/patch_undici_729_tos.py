...
# Certification-only compatibility patch for the installed dependency tree.
# This reproduces the runtime portions of nodejs/undici PR #5547 for the
# currently reviewed Undici 7.29.0 lock. It changes neither product source nor
# package.json/package-lock.json and refuses to run if the dependency drifts.
...
# CTW_CERT_UNDICI_729_UPSTREAM_TOS_FIX
...
checks = {
    'request preserves unspecified ToS': 'this.typeOfService = typeOfService\n' in request_after,
